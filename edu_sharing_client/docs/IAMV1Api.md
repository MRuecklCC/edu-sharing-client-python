...
[**remove_node_list**](IAMV1Api.md#remove_node_list) | **DELETE** /iam/v1/people/{repository}/{person}/nodeList/{list}/{node} | Deelete a node of a node list of a user
...
from edu_sharing_client.api import iamv1_api
...
with edu_sharing_client.ApiClient(configuration) as api_client:
    ...
    api_instance = iamv1_api.IAMV1Api(api_client)
