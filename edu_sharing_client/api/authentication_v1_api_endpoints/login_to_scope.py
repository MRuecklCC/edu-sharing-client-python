...
# body param
SchemaForRequestBodyApplicationJson = LoginCredentials


request_body_login_credentials = api_client.RequestBody(
    content={
...
_path = '/authentication/v1/loginToScope'
_method = 'POST'
...
class LoginToScope(api_client.Api):
    ...
    def login_to_scope(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_login_credentials.serialize(body, content_type)
