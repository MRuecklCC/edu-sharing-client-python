...
request_path__property = api_client.PathParameter(
    name="property",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ModelPropertySchema,
    required=True,
)
_path = '/stream/v1/properties/{repository}/{property}'
_method = 'GET'
...
class GetPropertyValues(api_client.Api):
