...
request_query_authority = api_client.QueryParameter(
    name="authority",
...
request_path_entry = api_client.PathParameter(
    name="entry",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EntrySchema,
    required=True,
)
_path = '/stream/v1/status/{repository}/{entry}'
_method = 'PUT'
...
class UpdateEntry(api_client.Api):
