...
# body param
SchemaForRequestBodyApplicationJson = WorkflowHistory


request_body_workflow_history = api_client.RequestBody(
    content={
...
_path = '/node/v1/nodes/{repository}/{node}/workflow'
_method = 'PUT'
...
class AddWorkflowHistory(api_client.Api):
    ...
    def add_workflow_history(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_workflow_history.serialize(body, content_type)
