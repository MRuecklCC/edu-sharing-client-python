...
request_query_handle_mode = api_client.QueryParameter(
    name="handleMode",
    style=api_client.ParameterStyle.FORM,
    schema=HandleModeSchema,
    explode=True,
)
# path params
...
_path = '/node/v1/nodes/{repository}/{node}/publish'
_method = 'POST'
...
class PublishCopy(api_client.Api):
