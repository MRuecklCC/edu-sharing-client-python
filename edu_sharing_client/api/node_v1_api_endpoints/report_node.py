...
# query params
ReasonSchema = StrSchema
UserEmailSchema = StrSchema
UserCommentSchema = StrSchema
...
request_query_user_comment = api_client.QueryParameter(
    name="userComment",
    style=api_client.ParameterStyle.FORM,
...
_path = '/node/v1/nodes/{repository}/{node}/report'
_method = 'POST'
...
class ReportNode(api_client.Api):
