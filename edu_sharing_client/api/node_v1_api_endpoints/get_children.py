...
request_query_assoc_name = api_client.QueryParameter(
    name="assocName",
    style=api_client.ParameterStyle.FORM,
    schema=AssocNameSchema,
    explode=True,
)
...
class GetChildren(api_client.Api):
