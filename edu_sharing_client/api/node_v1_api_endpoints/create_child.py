...
request_query_assoc_type = api_client.QueryParameter(
    name="assocType",
    style=api_client.ParameterStyle.FORM,
    schema=AssocTypeSchema,
    explode=True,
)
# path params
...
_path = '/node/v1/nodes/{repository}/{node}/children'
_method = 'POST'
...
class CreateChild(api_client.Api):
