...
_path = '/collection/v1/collections/{repository}/{collection}/children/proposals'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = AbstractEntries
...
class GetCollectionsProposals(api_client.Api):
