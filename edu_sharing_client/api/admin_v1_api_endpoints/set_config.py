...
# body param
SchemaForRequestBodyApplicationJson = RepositoryConfig


request_body_repository_config = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
_path = '/admin/v1/repositoryConfig'
_method = 'PUT'
...
class SetConfig(api_client.Api):
    ...
    def set_config(
        ...
        if body is not unset:
            serialized_data = request_body_repository_config.serialize(body, content_type)
