...
LoglevelSchema = StrSchema
AppenderSchema = StrSchema
...
request_query_loglevel = api_client.QueryParameter(
    name="loglevel",
    style=api_client.ParameterStyle.FORM,
...
request_query_appender = api_client.QueryParameter(
    name="appender",
    style=api_client.ParameterStyle.FORM,
    schema=AppenderSchema,
    explode=True,
)
_path = '/admin/v1/log'
_method = 'POST'
...
class ChangeLogging(api_client.Api):
    ...
    def change_logging(
        ...
        for parameter in (
            request_query_name,
            request_query_loglevel,
            request_query_appender,
        ):
