...
request_query_sticky = api_client.QueryParameter(
    name="sticky",
...
_path = '/admin/v1/import/refreshCache/{folder}'
_method = 'POST'
...
class RefreshCache(api_client.Api):
