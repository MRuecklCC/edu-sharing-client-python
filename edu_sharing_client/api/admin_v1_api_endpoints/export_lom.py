...
# query params
FilterQuerySchema = StrSchema
TargetDirSchema = StrSchema
SubObjectHandlerSchema = BoolSchema
...
request_query_filter_query = api_client.QueryParameter(
    name="filterQuery",
...
request_query_target_dir = api_client.QueryParameter(
    name="targetDir",
    style=api_client.ParameterStyle.FORM,
    schema=TargetDirSchema,
    required=True,
    explode=True,
)
request_query_sub_object_handler = api_client.QueryParameter(
    name="subObjectHandler",
    style=api_client.ParameterStyle.FORM,
    schema=SubObjectHandlerSchema,
    required=True,
    explode=True,
)
_path = '/admin/v1/export/lom'
_method = 'GET'
...
class ExportLom(api_client.Api):
    ...
    def export_lom(
        ...
        for parameter in (
            request_query_filter_query,
            request_query_target_dir,
            request_query_sub_object_handler,
        ):
