...
# body param
SchemaForRequestBodyApplicationJson = PersonDeleteOptions


request_body_person_delete_options = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
_path = '/admin/v1/deletePersons'
_method = 'PUT'
SchemaFor200ResponseBodyApplicationJson = PersonReport
...
class DeletePerson(api_client.Api):
    ...
    def delete_person(
        ...
        if body is not unset:
            serialized_data = request_body_person_delete_options.serialize(body, content_type)
