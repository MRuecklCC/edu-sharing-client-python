...
# body param
SchemaForRequestBodyApplicationJson = CreateUsage


request_body_create_usage = api_client.RequestBody(
    content={
...
_path = '/usage/v1/usages/repository/{repositoryId}'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = Usage
...
class SetUsage(api_client.Api):
    ...
    def set_usage(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_usage.serialize(body, content_type)
