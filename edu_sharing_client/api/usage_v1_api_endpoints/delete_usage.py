...
request_path_usage_id = api_client.PathParameter(
    name="usageId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=UsageIdSchema,
    required=True,
)
_path = '/usage/v1/usages/node/{nodeId}/{usageId}'
_method = 'DELETE'
...
class DeleteUsage(api_client.Api):
