...
# query params
PlatformIdSchema = StrSchema
ClientIdSchema = StrSchema
DeploymentIdSchema = StrSchema
AuthenticationRequestUrlSchema = StrSchema
KeysetUrlSchema = StrSchema
KeyIdSchema = StrSchema
AuthTokenUrlSchema = StrSchema
...
request_query_platform_id = api_client.QueryParameter(
    name="platformId",
...
request_query_deployment_id = api_client.QueryParameter(
    name="deployment_id",
    style=api_client.ParameterStyle.FORM,
...
request_query_authentication_request_url = api_client.QueryParameter(
    name="authentication_request_url",
    style=api_client.ParameterStyle.FORM,
    schema=AuthenticationRequestUrlSchema,
    required=True,
    explode=True,
)
request_query_keyset_url = api_client.QueryParameter(
    name="keyset_url",
    style=api_client.ParameterStyle.FORM,
    schema=KeysetUrlSchema,
    required=True,
    explode=True,
)
...
request_query_auth_token_url = api_client.QueryParameter(
    name="auth_token_url",
    style=api_client.ParameterStyle.FORM,
    schema=AuthTokenUrlSchema,
    required=True,
    explode=True,
)
_path = '/lti/v13/registration/static'
_method = 'POST'
...
class RegisterTest(api_client.Api):
    ...
    def register_test(
        ...
        for parameter in (
            request_query_platform_id,
            request_query_client_id,
            request_query_deployment_id,
            request_query_authentication_request_url,
            request_query_keyset_url,
            request_query_key_id,
            request_query_auth_token_url,
        ):
