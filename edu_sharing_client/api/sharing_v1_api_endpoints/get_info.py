...
request_path_share = api_client.PathParameter(
    name="share",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ShareSchema,
    required=True,
)
_path = '/sharing/v1/sharing/{repository}/{node}/{share}'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = SharingInfo
