...
class ContributorPropertiesSchema(
    ListSchema
):
    _items = StrSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'fields': FieldsSchema,
        'contributorProperties': ContributorPropertiesSchema,
    },
    total=False
)
...
request_query_search_word = api_client.QueryParameter(
    name="searchWord",
...
request_query_contributor_kind = api_client.QueryParameter(
    name="contributorKind",
    style=api_client.ParameterStyle.FORM,
    schema=ContributorKindSchema,
    required=True,
    explode=True,
)
...
request_query_contributor_properties = api_client.QueryParameter(
    name="contributorProperties",
    style=api_client.ParameterStyle.FORM,
    schema=ContributorPropertiesSchema,
    explode=True,
)
# path params
...
_path = '/search/v1/queries/{repository}/contributor'
_method = 'GET'
...
class SearchContributor(api_client.Api):
    ...
    def search_contributor(
        ...
        for parameter in (
            request_query_search_word,
            request_query_contributor_kind,
            request_query_fields,
            request_query_contributor_properties,
        ):
