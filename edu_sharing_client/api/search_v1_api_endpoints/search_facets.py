...
# body param
SchemaForRequestBodyApplicationJson = SearchParametersFacets


request_body_search_parameters_facets = api_client.RequestBody(
    content={
...
_path = '/search/v1/queries/{repository}/{metadataset}/{query}/facets'
_method = 'POST'
...
class SearchFacets(api_client.Api):
    ...
    def search_facets(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_search_parameters_facets.serialize(body, content_type)
