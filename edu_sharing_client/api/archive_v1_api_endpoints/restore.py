...
class ArchivedNodeIdsSchema(
    ListSchema
):
    _items = StrSchema
TargetSchema = StrSchema
...
request_query_archived_node_ids = api_client.QueryParameter(
    name="archivedNodeIds",
    style=api_client.ParameterStyle.FORM,
    schema=ArchivedNodeIdsSchema,
    required=True,
    explode=True,
)
...
_path = '/archive/v1/restore/{repository}'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = RestoreResults
...
class Restore(api_client.Api):
    ...
    def restore(
        ...
        for parameter in (
            request_query_archived_node_ids,
