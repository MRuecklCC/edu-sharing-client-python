...
# body param
SchemaForRequestBodyApplicationJson = UserCredential


request_body_user_credential = api_client.RequestBody(
    content={
...
_path = '/iam/v1/people/{repository}/{person}/credential'
_method = 'PUT'
...
class ChangeUserPassword(api_client.Api):
    ...
    def change_user_password(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_credential.serialize(body, content_type)
