...
# body param
SchemaForRequestBodyApplicationJson = GroupSignupDetails


request_body_group_signup_details = api_client.RequestBody(
    content={
...
_path = '/iam/v1/groups/{repository}/{group}/signup/config'
_method = 'POST'
...
class SignupGroupDetails(api_client.Api):
    ...
    def signup_group_details(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_group_signup_details.serialize(body, content_type)
