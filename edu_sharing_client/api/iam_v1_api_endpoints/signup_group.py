...
_path = '/iam/v1/groups/{repository}/{group}/signup'
_method = 'POST'
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def INVALIDPASSWORD(cls):
        return cls("InvalidPassword")
    
    @classmethod
    @property
    def ALREADYINLIST(cls):
        return cls("AlreadyInList")
    
    @classmethod
    @property
    def ALREADYMEMBER(cls):
        return cls("AlreadyMember")
...
class SignupGroup(api_client.Api):
