...
# body param
SchemaForRequestBodyApplicationJson = ProfileSettings


request_body_profile_settings = api_client.RequestBody(
    content={
...
_path = '/iam/v1/people/{repository}/{person}/profileSettings'
_method = 'PUT'
...
class SetProfileSettings(api_client.Api):
    ...
    def set_profile_settings(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_profile_settings.serialize(body, content_type)
