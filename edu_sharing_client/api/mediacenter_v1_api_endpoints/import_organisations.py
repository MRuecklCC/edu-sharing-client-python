...
_path = '/mediacenter/v1/import/organisations'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = OrganisationsImportResult
...
class ImportOrganisations(api_client.Api):
