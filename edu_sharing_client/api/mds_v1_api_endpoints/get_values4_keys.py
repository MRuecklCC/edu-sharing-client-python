...
_path = '/mds/v1/metadatasets/{repository}/{metadataset}/values_for_keys'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = Suggestions
...
class GetValues4Keys(api_client.Api):
