...
request_query_caption = api_client.QueryParameter(
    name="caption",
...
request_query_node_id = api_client.QueryParameter(
    name="nodeId",
    style=api_client.ParameterStyle.FORM,
    schema=NodeIdSchema,
    explode=True,
...
request_path_widget = api_client.PathParameter(
    name="widget",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WidgetSchema,
    required=True,
)
_path = '/mds/v1/metadatasets/{repository}/{metadataset}/values/{widget}/suggest'
_method = 'POST'
SchemaFor200ResponseBodyApplicationJson = MdsValue
...
class SuggestValue(api_client.Api):
    ...
    def suggest_value(
        ...
        for parameter in (
            request_query_caption,
            request_query_parent,
            request_query_node_id,
        ):
